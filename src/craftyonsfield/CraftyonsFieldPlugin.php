...
class CraftyonsFieldPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('Adds a Craftyons field (which loads Tachyons components as HTML) for prototyping');
    }
    ...
    {
        return 'https://github.com/j-greig/craftyonsfield/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/j-greig/craftyonsfield/master/releases.json';
    }
    ...
    {
        Craft::import('plugins.craftyonsfield.twigextensions.CraftyonsFieldTwigExtension');

        return new CraftyonsFieldTwigExtension();
    }
